...
const Products = () => {
	return (
		<>
			<div className='grid grid-cols-4 row-span-{n} gap-4 flex-1'>
				<div className='flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]'>
					<img
						className='w-full h-auto rounded-t-xl'
						src='https://res.cloudinary.com/dp1rpqkjb/image/upload/v1687603898/sweatshirts/gharliera_sweatshirt_uwj9of.jpg'
